    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edicion de auditoria</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                        ...
                        <form action="controller_edit.php" method="post">
                            ...
                            <center>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <center>
                                            <button type="submit" onclick="return confirm('Revise la información antes de enviar')" class="btn btn-primary btn-block">Actualizar auditoria</button>
                                        </center>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
